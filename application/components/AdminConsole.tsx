  ...
  const confirmSwitchMode = async (e: React.FormEvent) => {
      ...
      if (isValid) {
          ...
          try {
              ...
              // 3. Transition fluide sans rechargement de page
              setTimeout(() => {
                  // Dispatcher un événement pour notifier tous les composants du changement de mode
                  ...
                  setFeedback({ type: 'success', msg: `Mode ${switchingMode === 'production' ? 'PRODUCTION' : 'DÉVELOPPEUR'} activé` });
                  setTimeout(() => setFeedback(null), 3000);
              }, 2500);
