...
class MockDatabase {
  ...
  private systemSettings: SystemSettings = {
    ...
    invoices: {},
    images: { endpoint: { ...DEFAULT_WEBHOOK } },
    videos: { endpoint: { ...DEFAULT_WEBHOOK } },
    chat: { provider: 'gemini', value: '' },
    library: {},
    webhooks: {
      unified_workspace: { ...DEFAULT_WEBHOOK, enabled: false },
      chat: { ...DEFAULT_WEBHOOK, enabled: false },
      images: { ...DEFAULT_WEBHOOK, enabled: false },
      videos: { ...DEFAULT_WEBHOOK, enabled: false },
      video_editor: { ...DEFAULT_WEBHOOK, enabled: false },
      news: { ...DEFAULT_WEBHOOK, enabled: false },
      clients: { ...DEFAULT_WEBHOOK, enabled: false },
      invoices: { ...DEFAULT_WEBHOOK, enabled: false },
      contracts: { ...DEFAULT_WEBHOOK, enabled: false },
      email_sender: { ...DEFAULT_WEBHOOK, enabled: false },
      prospection: { ...DEFAULT_WEBHOOK, enabled: false },
      projects: { ...DEFAULT_WEBHOOK, enabled: false },
      google_workspace: { ...DEFAULT_WEBHOOK, enabled: false }
    },
    modules: {}
  };
