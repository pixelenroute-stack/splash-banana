...
import { Palette, Layout, Upload, Image as ImageIcon, Type, Link, User, Save, Loader2 } from 'lucide-react';
...
export const BrandingEditor: React.FC<BrandingEditorProps> = ({ settings, updateSetting, onSave, isSaving }) => {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
            ...
            <div className="flex justify-between items-center bg-slate-900/80 backdrop-blur p-4 rounded-2xl border border-slate-800 sticky top-0 z-20 shadow-xl">
                <div>
                    <h2 className="text-white font-bold flex items-center gap-2">
                        <Palette size={20} className="text-purple-400"/> Personnalisation
                    </h2>
                    <p className="text-xs text-slate-400">Modifiez l'apparence et l'identité de l'application</p>
                </div>
                <div>
                    <button 
                        onClick={onSave}
